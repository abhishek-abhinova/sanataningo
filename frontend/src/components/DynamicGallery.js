  ...
  return (
    <div className="dynamic-gallery">
      ...
      <div className="gallery-grid">
        {filteredGallery.slice(0, limit).map((item) => (
          <div key={item._id} className="gallery-item" onClick={() => openLightbox(item)}>
          ...
          <div className="lightbox-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="lightbox-media">
              {selectedItem.type === 'photo' ? (
                <img src={selectedItem.file} alt={selectedItem.title} />
              ) : (
                <video src={selectedItem.file} controls autoPlay />
              )}
            </div>
