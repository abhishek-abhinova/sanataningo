    ...
    <body>
      <div class="receipt">
        ...
        <div class="receipt-no">
          <strong>Receipt No: ${donation.donationId}</strong> | Date: ${new Date(donation.donationDate || donation.createdAt).toLocaleDateString()}
        </div>
        ...
        <div class="amount-row">
          ...
          <div style="margin-top: 10px; font-size: 14px; color: #666;">
            Amount in words: ${numberToWords(donation.amount)} Rupees Only
          </div>
        </div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>We are deeply grateful for your generous donation of <strong>₹${donation.amount}</strong> towards <strong>${donation.purpose}</strong>.</p>
